...
class Report {
  ...
  async getCoverageMapFromAllCoverageFiles () {
    ...
    //Todo: Might be able to remove this variable
    ...
    for (const v8ScriptCov of v8ProcessCov.result) {
      try {
        ...
        //These lines are covered in Pull Request: https://github.com/bcoe/c8/pull/451
        /* c8 ignore next 5 */
    ...
    for (const [converter, { path, functions }] of possibleCjsEsmBridges) {
      //Might be able to remove this conditional if block
   ...
   *
   * Be sure to mirror any changes to the mock report class in test/report-mock.js
   *
